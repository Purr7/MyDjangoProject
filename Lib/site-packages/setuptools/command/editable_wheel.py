...
class editable_wheel(Command):
    ...
    def _select_strategy(
        self, name: str, tag: str, build_lib: _Path,
    ) -> "EditableStrategy":
...
class _LinkTree(_StaticPth):
    ...
    def __init__(
        self, dist: Distribution, name: str, auxiliary_dir: _Path, build_lib: _Path,
    ):
...
def _find_package_roots(
    packages: Iterable[str], package_dir: Mapping[str, str], src_root: _Path,
) -> Dict[str, str]:
